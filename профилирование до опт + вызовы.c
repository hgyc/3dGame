...
//
//// =============== PROFILING CONFIG ===============
//#define PROFILING_MODE 1  // 1 = ÔÓÙËÎËÓ‚‡ÌËÂ ÌÂÓÔÚËÏËÁËÓ‚‡ÌÌÓÈ ‚ÂÒËË
//// ================================================
//
...
//        b->dir = (rand() % 2) ? 1 : -1;
//        b->active = 1; // ıÓÚˇ ‚ ‚‡¯ÂÏ ÍÓ‰Â active ÌÂ ËÒÔÓÎ¸ÁÛÂÚÒˇ ‚ ÒÔËÒÍÂ
//    }
//
//    score = 999999;
//    wave = 99;
...
//    compileTextShader();
//    setupText();
//    const float PLAYER_X = 0.0f; // ÙËÍÒËÓ‚‡ÌÌ‡ˇ ÔÓÁËˆËˇ
//    float x = PLAYER_X;
//
//    glEnable(GL_BLEND);
